    ...
    <section className="text-white w-full px-8 py-40 flex flex-row justify-between">
      <div className="grow flex flex-col items-center px-8 gap-y-6">
        ...
        <div className="text-6xl w-full flex flex-row gap-4">
          <SpecialWord className="font-hero bg-gradient-1" text="Hitarth" />
          <SpecialWord className="font-hero bg-gradient-2" text="Desai" />
        </div>
        <div className="text-3xl w-full flex flex-row gap-4">
          <SpecialWord className="font-hero bg-gradient-3" text="React.JS" />
          &
          <SpecialWord className="font-hero bg-gradient-3" text="Next.JS" />
          connoisseur
        </div>
